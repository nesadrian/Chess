...
public class Board {
    ...
    public Board() throws IOException {
        ...
        a1 = new Square("a1", 1, 1, new Rook(1, 8, true), Color.decode("#1fafae"));
        a2 = new Square("a2", 1, 2, new Pawn(2, 8, true),Color.decode("#fffefc"));
        a3 = new Square("a3", 1, 3, null, Color.decode("#1fafae"));
        a4 = new Square("a4", 1, 4, null, Color.decode("#fffefc"));
        a5 = new Square("a5", 1, 5, null, Color.decode("#1fafae"));
        a6 = new Square("a6", 1, 6, null, Color.decode("#fffefc"));
        a7 = new Square("a7", 1, 7, new Pawn(7, 1, false), Color.decode("#1fafae"));
        a8 = new Square("a8", 1, 8, new Rook(8, 8, false), Color.decode("#fffefc"));
        
        b1 = new Square("b1", 2, 1, new Knight(1, 7, true), Color.decode("#fffefc"));
        b2 = new Square("b2", 2, 2, new Pawn(2, 7, true), Color.decode("#1fafae"));
        b3 = new Square("b3", 2, 3, null, Color.decode("#fffefc"));
        b4 = new Square("b4", 2, 4, null, Color.decode("#1fafae"));
        b5 = new Square("b5", 2, 5, null, Color.decode("#fffefc"));
        b6 = new Square("b6", 2, 6, null, Color.decode("#1fafae"));
        b7 = new Square("b7", 2, 7, new Pawn(7, 1, false), Color.decode("#fffefc"));
        b8 = new Square("b8", 2, 8, new Knight(8, 7, false), Color.decode("#1fafae"));
        
        c1 = new Square("c1", 3, 1, new Bishop(1, 6, true), Color.decode("#1fafae"));
        c2 = new Square("c2", 3, 2, new Pawn(2, 6, true), Color.decode("#fffefc"));
        c3 = new Square("c3", 3, 3, null, Color.decode("#1fafae"));
        c4 = new Square("c4", 3, 4, null, Color.decode("#fffefc"));
        c5 = new Square("c5", 3, 5, null, Color.decode("#1fafae"));
        c6 = new Square("c6", 3, 6, null, Color.decode("#fffefc"));
        c7 = new Square("c7", 3, 7, new Pawn(7, 1, false), Color.decode("#1fafae"));
        c8 = new Square("c8", 3, 8, new Bishop(8, 6, false), Color.decode("#fffefc"));
       
        d1 = new Square("d1", 4, 1, new Queen(1, 5, true), Color.decode("#fffefc"));
        d2 = new Square("d2", 4, 2, new Pawn(2, 5, true), Color.decode("#1fafae"));
        d3 = new Square("d3", 4, 3, null, Color.decode("#fffefc"));
        d4 = new Square("d4", 4, 4, null, Color.decode("#1fafae"));
        d5 = new Square("d5", 4, 5, null, Color.decode("#fffefc"));
        d6 = new Square("d6", 4, 6, null, Color.decode("#1fafae"));
        d7 = new Square("d7", 4, 7, new Pawn(7, 1, false), Color.decode("#fffefc"));
        d8 = new Square("d8", 4, 8, new Queen(8, 5, false), Color.decode("#1fafae"));
       
        e1 = new Square("e1", 5, 1, new King(1, 4, true), Color.decode("#1fafae"));
        e2 = new Square("e2", 5, 2, new Pawn(2, 4, true), Color.decode("#fffefc"));
        e3 = new Square("e3", 5, 3, null, Color.decode("#1fafae"));
        e4 = new Square("e4", 5, 4, null, Color.decode("#fffefc"));
        e5 = new Square("e5", 5, 5, null, Color.decode("#1fafae"));
        e6 = new Square("e6", 5, 6, null, Color.decode("#fffefc"));
        e7 = new Square("e7", 5, 7, new Pawn(7, 1, false), Color.decode("#1fafae"));
        e8 = new Square("e8", 5, 8, new King(8, 4, false), Color.decode("#fffefc"));
        
        f1 = new Square("f1", 6, 1, new Bishop(1, 3, true), Color.decode("#fffefc"));
        f2 = new Square("f2", 6, 2, new Pawn(2, 3, true), Color.decode("#1fafae"));
        f3 = new Square("f3", 6, 3, null, Color.decode("#fffefc"));
        f4 = new Square("f4", 6, 4, null, Color.decode("#1fafae"));
        f5 = new Square("f5", 6, 5, null, Color.decode("#fffefc"));
        f6 = new Square("f6", 6, 6, null, Color.decode("#1fafae"));
        f7 = new Square("f7", 6, 7, new Pawn(7, 1, false), Color.decode("#fffefc"));
        f8 = new Square("f8", 6, 8, new Bishop(8, 3, false), Color.decode("#1fafae"));
       
        g1 = new Square("g1", 7, 1, new Knight(1, 2, true), Color.decode("#1fafae"));
        g2 = new Square("g2", 7, 2, new Pawn(2, 2, true), Color.decode("#fffefc"));
        g3 = new Square("g3", 7, 3, null, Color.decode("#1fafae"));
        g4 = new Square("g4", 7, 4, null, Color.decode("#fffefc"));
        g5 = new Square("g5", 7, 5, null, Color.decode("#f1fafae"));
        g6 = new Square("g6", 7, 6, null, Color.decode("#fffefc"));
        g7 = new Square("g7", 7, 7, new Pawn(7, 1, false), Color.decode("#1fafae"));
        g8 = new Square("g8", 7, 8, new Knight(8, 2, false), Color.decode("#fffefc"));
        
        h1 = new Square("h1", 8, 1, new Rook(1, 1, true), Color.decode("#fffefc"));
        h2 = new Square("h2", 8, 2, new Pawn(2, 1, true), Color.decode("#1fafae"));
        h3 = new Square("h3", 8, 3, null, Color.decode("#fffefc"));
        h4 = new Square("h4", 8, 4, null, Color.decode("#1fafae"));
        h5 = new Square("h5", 8, 5, null, Color.decode("#fffefc"));
        h6 = new Square("h6", 8, 6, null, Color.decode("#1fafae"));
        h7 = new Square("h7", 8, 7, new Pawn(7, 1, false), Color.decode("#fffefc"));
        h8 = new Square("h8", 8, 8, new Rook(8, 1, false), Color.decode("#1fafae"));
